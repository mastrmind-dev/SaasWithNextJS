...
const Step3 = ({ onNext }: StepProps) => {
  ...
  return (
    <div className="flex items-center justify-center w-full p-4 gap-x-[30px] ">
      <div
        className={`flex flex-col gap-y-[10px] w-[160px] h-[150px] bg-[#FFFFFF1A] border-[0.5px] border-[#FFFFFF80] rounded-[18px] py-[12px] px-[0px] items-center justify-center text-center ${
      ...
      >
        ...
        <span className="font-[600] text-[16px] text-[#B9B9B9]">Rookie</span>
      </div>
      <div
        className={`flex flex-col gap-y-[10px] w-[160px] h-[150px] bg-[#FFFFFF1A] border-[0.5px] border-[#FFFFFF80] rounded-[18px] py-[12px] px-[0px] items-center justify-center text-center ${
      ...
      >
        ...
        <span className="font-[600] text-[16px] text-[#B9B9B9]">Junior</span>
      </div>
      <div
        className={`flex flex-col gap-y-[10px] w-[160px] h-[150px] bg-[#FFFFFF1A] border-[0.5px] border-[#FFFFFF80] rounded-[18px] py-[12px] px-[40px] items-center justify-center text-center ${
      ...
      >
        ...
        <span className="font-[600] text-[16px] text-[#B9B9B9]">Mid Level</span>
      </div>
      <div
        className={`flex flex-col gap-y-[10px] w-[160px] h-[150px] bg-[#FFFFFF1A] border-[0.5px] border-[#FFFFFF80] rounded-[18px] py-[12px] px-[40px] items-center justify-center text-center ${
      ...
      >
        ...
        <span className="font-[600] text-[16px] text-[#B9B9B9]">Senior</span>
      </div>
    </div>
  );
};
